...
-(IBAction)sendMail:(UIButton*)button
{
    if([MFMailComposeViewController canSendMail])
    {
        ...
        [mailController setSubject:@"Documents Scanner OCR"];
        [mailController setToRecipients:[NSArray arrayWithObjects:@"info@sprintsols.com",nil]];
        
        NSString *emailBody = [NSString stringWithFormat:@"<html><body><br/><br/><br/><p>Sent Via <a href='http://www.sprintsols.com'>Documents Scanner OCR</a></p> </body></html>"];
