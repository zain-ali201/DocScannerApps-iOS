...
@interface ProcessViewController ()<GADInterstitialDelegate>
...
- (void)viewDidLoad {
    ...
    self.interstitial = [[GADInterstitial alloc]
                         initWithAdUnitID:@"ca-app-pub-1649226560506116/2232409695"];
    self.interstitial.delegate = self;
    GADRequest *request = [GADRequest request];
    request.testDevices = @[ @"cd770ce14a810f5c98b9ecc5d83af63e" ];
